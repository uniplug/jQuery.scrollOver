...
(function() {
  ...
  $.fn.ScrollOver1 = function(options) {
    var triggerEvent;
    ...
    this.objSettings = {};
    this.objSettings.throttle = 200;
    this.objSettings.wait_for_tick = false;
    this.objSettings.windowOffset = false;
    this.objSettings.scrollSettings = {};
    this.objSettings.offsets = [];
    this.Init();
    return this;
  };
...
//# sourceMappingURL=jquery.scrollover.map
