...
#			objScrollOver.log(objScrollOver)
	...
	@.objSettings = {}
	@.objSettings.throttle = 200
	@.objSettings.wait_for_tick = false
	@.objSettings.windowOffset = false
	@.objSettings.scrollSettings = {}
	@.objSettings.offsets = []
	@Init()
